...
class Game:
    def __init__(self,screen):
        ...
        # Player setup
        player_speed = 5
        player_sprite = Player((self.screen_width / 2,self.screen_height), self.screen_width, player_speed)
        self.player = pygame.sprite.GroupSingle(player_sprite)

        # health and score setup
        self.lives = 3
        self.live_surface = pygame.image.load('graphics/player.png').convert_alpha()
        self.live_x_start_pos = self.screen_width - (self.live_surface.get_size()[0] * 2 + 20)
        self.score = 0
        ...
        self.block_color = (241,79,80) #redish color
